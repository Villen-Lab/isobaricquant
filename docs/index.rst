.. isobaricquant documentation master file, created by
   sphinx-quickstart on Tue May  3 16:13:28 2022.
...
Download `latest
version <https://github.com/Villen-Lab/isobaricquant/releases/download/v1.0.1/IsobaricQuant_WIN.jar>`__
...
| **Labels / confLabels:** Labels to be searched in (use comma separated
...
| **recalculate_intensities / recalcIntensities:** If activated, it will
...
| **precSignalWindow / ms1PrecWindowDaltons:** Dalton window that will
  be used to calculate the precursor signal percentage in the MS1 scan.
| **Values:** input by user
| **Default:** 1

| **search.fragment.window / searchFragmentWindowTolerance:** MS2
  precursor window (Da)
| **Values:** input by user
| **Default:** 2.5

| **search.fragment.file / generateFragmentIonsFile:** Generates a file
...
| **search.method / searchMethod:** Search method used to select a TMT
  reporter ion peak
| **Values:** most_intense, least_intense, lower_ppm_error
| **Default:** most_intense

| **ms1DepthSearch / ms1DepthSearch:** Number of MS1 scans depth to
